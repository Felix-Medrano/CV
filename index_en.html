                ...
                <div class="contenedor">
                    <div class="bloqueTitulo">
                        <h2 class="titulo">About Me</h2>
                            <h3 class="subtitulo">Production Supervisor - Materials Supervisor - Quality Assurement - Software Development - Web Design</h3>
                    </div> 
                </div> 
                    ...
                    <div class="row">
                        <div class="col50">
                            <h3>Computer Systems Engineer</h3>
                                <p>Thanks to my training that gave me logical and analytical thinking, and my experience in various branches of the industry, I know that I can add value and continue to develop professionally in a company that shares my values ​​and expectations. <br></p>
                                <p>I am a person who knows how to work under pressure, with a taste for challenges, and an insatiable hunger to learn, either self-taught or with Coaching, always open to change, with a Win-Win, Humanist mentality.</p>
                        </div>
                                ...
                                <form action="index.php" method="POST">
                                    <div class="row">
                                        <div class="col50">
                                            <h2>Contact me</h2>
                                            <div class="formBlock">
                                                <input type="text" name="nombre" class="formControl" placeholder="Name" required>
                                            </div>
                                            <div class="formBlock">
                                                <input type="email" name="correo" class="formControl" placeholder="e-mail" required>
                                            </div>
                                            <div class="formBlock">
                                                <input type="text" name="asunto" class="formControl" placeholder="Subject" required>
                                            </div>
                                            <div class="formBlock mensaje">
                                                <textarea id="form_message" name="mensaje" class="formControl" placeholder="Message" rows="7" required="required" data-error="Please, leave me a message." style="margin-top: 0px; margin-bottom: 0px; height: 169px;"></textarea>
                                            </div>
